...
public class AdminboardPaging {
	...
	public void makePagingHTML() {
		...
		if(startPage>pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='adminnoticeboardList?pg="+(startPage-1)+"'>Previous</a></li>");
		for(int i=startPage; i<=endPage; i++) {
			if(i==currentPage)
				pagingHTML.append("<li class='page-item'><a class='page-link' href='adminnoticeboardList?pg="+i+"'></a></li>");
			else
				pagingHTML.append("<li class='page-item'><a class='page-link' href='adminnoticeboardList?pg="+i+"'></a></li>");
		}
		if(endPage<totalP)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='adminnoticeboardList?pg="+(endPage+1)+"'>Next</a></li>");
	}
